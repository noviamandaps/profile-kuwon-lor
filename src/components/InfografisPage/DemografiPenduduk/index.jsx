        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-8 pt-24 flex flex-col">
          <div className="">
            ...
            <p className="text-gray-600 mb-14">
              Data persebaran penduduk yang ada di Dukuh Kuwon Lor
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex flex-col justify-center items-center flex-grow border border-gray-200 py-8 rounded-lg gap-5">
              ...
              <div className="text-center">
                <h5 className="text-xl font-medium text-gray-600 mb-1">
                  Jumlah KK
                </h5>
                <p className="text-2xl sm:text-3xl font-bold text-emerald-600">
                  {dataPenduduk.jumlahKK} KK
                </p>
              </div>
            </div>
            <div className="flex flex-col justify-center items-center flex-grow border border-gray-200 py-8 rounded-lg gap-5 ">
